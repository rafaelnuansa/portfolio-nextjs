...
export function WelcomeSection() {
	...
	const [text] = useState([
		"Backend with Laravel Framework",
		"Backend with Codeigniter Framework",
			...
			<section id="intro" className="section" ref={introRef}>
				<div className="grid grid-cols-1 md:grid-cols-[1fr_0.5fr] lg:grid-cols-[1fr_0.7fr] gap-4 items-center">
					<div className="py-5 md:py-10">
						...
						>
							<p>
								Hi, I&apos;m <mark>Rafael Nuansa</mark> a <mark>Full Stack</mark>  Web Developer.
							</p>
						</h1>

						<div className="mt-3 relative mb-3 flex flex-col overflow-hidden">
							<p
								ref={ref}
